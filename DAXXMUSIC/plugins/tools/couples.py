...
async def ctest(_, message):
    ...
    try:
        ...
        try:
            # Download photos and handle exceptions
        ...
        # Apply circular mask for the images
        ...
        **ᴛᴏᴅᴀʏ's ᴄᴏᴜᴘʟᴇ ᴏғ ᴛʜᴇ ᴅᴀʏ :
        ...
        # Upload to Telegraph and get the link
        ...
        print(f"Error: {str(e)}")
        await message.reply_text("❌ An error occurred while generating the couple's image.")
