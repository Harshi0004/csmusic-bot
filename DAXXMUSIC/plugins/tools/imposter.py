...
ROY = [
    [
        InlineKeyboardButton(
            text="ᴀᴅᴅ ᴍᴇ",
            url="https://t.me/csvcmusicbot?startgroup=true"),
    ],
]
...
async def chk_usr(_, message: Message):
    ...
    # Simplify user info comparison and update
    updated_info = False
...
**๏ ʙᴇғᴏʀᴇ** ➛ {lastname_before}
**๏ ᴀғᴛᴇʀ** ➛ {lastname_after}
"""
    
    # Update the user data if there were changes
    if updated_info:
        await add_userdata(
            message.from_user.id,
            message.from_user.username,
