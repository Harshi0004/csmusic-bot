...
# Purge command: Delete all messages between the replied message and the command message
...
# Super purge command: Similar to purge but could be intended for another use
...
# Delete specific message: Deletes the replied-to message
